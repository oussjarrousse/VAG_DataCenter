...
/**
 * This is the model class for table "SystemUsers".
 *
 * The followings are the available columns in table 'SystemUsers':
 * @property string $idSystemUser
...
class SystemUsers extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'sessions' => array(self::HAS_MANY, 'Sessions', 'SystemUsers_idSystemUser'),
			'roles' => array(self::MANY_MANY, 'Roles', 'SystemUsers_has_Roles(SystemUsers_idSystemUser, Roles_idRoles)'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('idSystemUser',$this->idSystemUser,true);
